...
\title{Instructions for Dialogue Systems Final Project Report}
...
\maketitle
\begin{abstract}
  Place a brief summary (4-5 sentences) of your project here.
\end{abstract}

\section{Introduction}

This is where the introduction to your report will go.
Modify the following sections by removing the content and
making your own sections. Add in sections as appropriate
for covering the topics that span the proposal, specification,
and final report content. 
